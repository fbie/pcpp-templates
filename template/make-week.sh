...
# Test script
TEST_SH="java -cp .:pcpp/week$WEEK:lib/junit-4.12.jar:lib/hamcrest-core-1.3.jar org.junit.runner.JUnitCore pcpp.week$WEEK.TestSubmission"

# Build the directory
ROOT=$(pwd)/week$WEEK
PKG=$ROOT/pcpp/week$WEEK
mkdir -p $PKG
